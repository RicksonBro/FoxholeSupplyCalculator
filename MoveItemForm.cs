...
public class MoveItemForm : Form
{
    ...
    public MoveItemForm(List<string> subgroupNames, int maxQuantity)
    {
        ...
        cbSubgroups = new ComboBox { Location = new Point(150, 15), Width = 120, DropDownStyle = ComboBoxStyle.DropDownList };

        foreach (var name in subgroupNames)
            cbSubgroups.Items.Add(name);
